...
export default function OfflinePage() {
  ...
  return (
    <div style={{ margin: 0, background: T.bg, color: T.text, fontFamily: 'Inter, system-ui, sans-serif', display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100svh', flexDirection: 'column', gap: 16, padding: 24, textAlign: 'center' }}>
