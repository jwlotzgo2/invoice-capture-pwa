...
const css = `
  ...
  * { box-sizing:border-box; }
  ...
  /* Avatar spans full width on desktop */
      ...
      <div className="settings-page">
        ...
        <main>
          <div className="settings-grid">
            ...
            {/* Avatar section — spans full width on desktop */}
            ...
            {/* Left column: Profile card + Organisation card */}
            ...
            {/* Right column: Notifications + Team + App/Install/Signout */}
            <div className="settings-col">
