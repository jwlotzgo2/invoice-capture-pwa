...
const css = `
  ...
  * { box-sizing:border-box; }
  ...
  .cap-title { font-family:'VT323',monospace;font-size:22px;letter-spacing:2px;color:${T.yellow};text-shadow:0 0 10px rgba(250,204,21,0.3);flex:1; }
  ...
  .t-card-title { font-family:'VT323',monospace;font-size:16px;letter-spacing:2px;color:${T.yellow};text-transform:uppercase;margin-bottom:12px;display:flex;align-items:center;gap:6px; }
  ...
  .t-input { width:100%;padding:9px 12px;background:${T.bg};border:1px solid ${T.border};border-radius:4px;color:${T.text};font-family:'Share Tech Mono',monospace;font-size:14px;outline:none;transition:border-color 0.2s,box-shadow 0.2s; }
  ...
  .t-select { width:100%;padding:9px 12px;background:${T.bg};border:1px solid ${T.border};border-radius:4px;color:${T.text};font-family:'Share Tech Mono',monospace;font-size:13px;outline:none;appearance:none;cursor:pointer; }
  .t-select:focus { border-color:${T.blue}; }
  .t-textarea { width:100%;padding:9px 12px;background:${T.bg};border:1px solid ${T.border};border-radius:4px;color:${T.text};font-family:'Share Tech Mono',monospace;font-size:14px;outline:none;resize:vertical;min-height:70px; }
  .t-textarea:focus { border-color:${T.blue};box-shadow:0 0 0 2px ${T.blueGlow}; }
  .t-textarea::placeholder { color:${T.textMuted}; }
  .save-btn { width:100%;padding:14px;background:${T.yellow};border:none;border-radius:6px;color:${T.bg};font-family:'VT323',monospace;font-size:20px;letter-spacing:3px;cursor:pointer;text-transform:uppercase;box-shadow:0 0 20px rgba(250,204,21,0.3);transition:box-shadow 0.2s,transform 0.1s; }
  ...
  .cancel-btn { width:100%;padding:11px;background:transparent;border:1px solid ${T.border};border-radius:6px;color:${T.textDim};font-family:'Share Tech Mono',monospace;font-size:13px;letter-spacing:1px;cursor:pointer;margin-top:8px; }
    ...
    <>
      ...
      <div className="cap-page">
        ...
        <div style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'40px 24px'}}>
          <div style={{fontFamily:'VT323,monospace',fontSize:16,letterSpacing:3,color:T.textMuted,marginBottom:24,textTransform:'uppercase'}}>Select Capture Method</div>
        ...
        <main style={{padding:16,paddingBottom:80}}>
          ...
          <div className="t-card">
            ...
            <div style={{marginBottom:12}}>
              ...
              <input className="t-input" style={{fontFamily:'Share Tech Mono,monospace'}} value={documentNumber||''} onChange={e=>setDocumentNumber(e.target.value||null)} placeholder="e.g. INV-0042" onFocus={focusBlue} onBlur={blurReset}/>
            </div>
