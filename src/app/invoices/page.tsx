...
const CAT_COLORS: Record<string, string> = {
  ...
  'Other': '#94a3b8', 'Uncategorised': '#475569',
};
...
const css = `
  ...
  * { box-sizing: border-box; }
  ...
  .dash { min-height: 100svh; background: ${T.bg}; font-family: 'Share Tech Mono','Courier New',monospace; color: ${T.text};
  ...
  .dash-title { font-family:'VT323',monospace;font-size:22px;letter-spacing:2px;color:${T.yellow};
  ...
  .period-btn { flex-shrink:0;padding:6px 14px;border-radius:4px;font-size:11px;letter-spacing:1px;
    border:1px solid ${T.border};background:transparent;color:${T.textDim};cursor:pointer;
    font-family:'Share Tech Mono',monospace;white-space:nowrap;text-transform:uppercase;transition:all 0.15s; }
  ...
  .capture-hero { margin:14px 16px;border-radius:8px;
    ...
    box-shadow:0 0 24px rgba(99,102,241,0.15);position:relative;overflow:hidden; }
  .capture-hero::before { content:'>';position:absolute;right:16px;top:50%;transform:translateY(-50%);
    font-family:'VT323',monospace;font-size:80px;color:rgba(99,102,241,0.08);line-height:1; }
  .capture-hero-text h2 { font-family:'VT323',monospace;font-size:22px;letter-spacing:2px;
    color:${T.yellow};margin:0 0 3px;text-shadow:0 0 8px rgba(250,204,21,0.3); }
  ...
  .capture-btn { display:flex;align-items:center;gap:6px;background:${T.yellow};color:${T.bg};
    border:none;border-radius:4px;padding:9px 14px;font-size:13px;letter-spacing:1px;
  ...
  .kpi-card.yellow::before { background:${T.yellow};box-shadow:0 0 8px rgba(250,204,21,0.4); }
  ...
  .kpi-label { font-size:10px;letter-spacing:2px;color:${T.textDim};text-transform:uppercase;margin-bottom:6px; }
  .kpi-value { font-family:'VT323',monospace;font-size:26px;color:${T.text};line-height:1;display:block; }
  .kpi-sub { font-size:10px;color:${T.textMuted};letter-spacing:1px;margin-top:4px;display:block; }
  .section-hdr { display:flex;align-items:center;justify-content:space-between;padding:0 16px;margin:14px 0 8px; }
  .section-title { font-family:'VT323',monospace;font-size:18px;letter-spacing:2px;color:${T.yellow}; }
  .section-link { font-size:11px;color:${T.blue};background:none;border:none;cursor:pointer;
    font-family:'Share Tech Mono',monospace;letter-spacing:1px;display:flex;align-items:center;gap:4px;text-decoration:none; }
  ...
  .supplier-rank { width:22px;height:22px;border-radius:4px;background:${T.surfaceHigh};
    ...
    color:${T.textDim};flex-shrink:0;font-family:'VT323',monospace;font-size:16px; }
  .supplier-name { font-size:13px;color:${T.text};white-space:nowrap;overflow:hidden;text-overflow:ellipsis; }
  .supplier-total { font-family:'Share Tech Mono',monospace;font-size:13px;color:${T.yellow};white-space:nowrap;flex-shrink:0; }
      ...
      <div className="dash">
        ...
        <header className="dash-header">
          <div className="dash-logo">
            <div className="dash-logo-mark"><Receipt size={16} color="#0d0d0d" /></div>
            <span className="dash-title">CAPTURE<span className="t-cursor">_</span></span>
          </div>
          <div style={{ display: 'flex', gap: 6 }}>
            {isAdmin && (
              <Link href="/admin" className="icon-btn" title="Admin"><Shield size={16} color="#6366f1" /></Link>
            )}
          </div>
        </header>
